######################################################################
#  BGA Module (Footprint) Creator for KiCAD v2009-04-28              #
#                                                                    #
...
if __name__ == '__main__':
    if len(sys.argv) != 5:
        print "BGA Module (Footprint) Creator for KiCAD v2009-04-28 By Opendous Inc."
        print "Include the resulting file as a library in your project."
        print "Usage:"
        print "  python", sys.argv[0], "#padsX, #padsY, padDiameter, pitch"
        ...
        print "    e.g; TFBGA180 IC with 14x14 pins, 0.5mm=19.7mil=197 radius, and"
        print "          0.8mm=31.5mil=315 pitch would be created with:"
        print "  python", sys.argv[0], "14 14 197 315"
        exit()
    createBGAModule(int(sys.argv[1]), int(sys.argv[2]), int(sys.argv[3]), int(sys.argv[4]))
