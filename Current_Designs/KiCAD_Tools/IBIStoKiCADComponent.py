######################################################################
#  IBIS to KiCAD Component v2010-04-02                               #
#                                                                    #
...
def IBIStoKiCADComponent(IBISFile, PartName):
    ...
    for line in file.readlines():
        ...
        if (foundComponent == 1):
            p1 = re.compile('^\d{1,3}[a-zA-Z]{0,3}\s+') # match at start of line a number followed by a letter followed by whitespace
            ...
            if (rpl1 != []):
                ...
                elif (("GPIO" in line) or ("DINPUT" in line) or ("DOUTRI" in line) or ("DIO" in line) or ("CLK" in line)):
                    # found a digital pin
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        print "IBIS to KiCAD Component v2010-04-02 By Opendous Inc."
