...
<Properties>
  ...
  <FrameText1=Drawn By: Opendous Inc.>
  <FrameText2=Date:>
  <FrameText3=Revision:>
</Properties>
<Symbol>
...
<Components>
  ...
  <L L6 1 220 140 8 -26 0 1 "56nH" 1 "" 0>
  <GND * 1 220 170 0 0 0 0>
  <L L7 1 330 60 -26 -44 0 0 "110nH" 1 "" 0>
  <L L8 1 360 140 8 -26 0 1 "15nH" 1 "" 0>
  <GND * 1 360 170 0 0 0 0>
  <L L9 1 470 60 -26 -44 0 0 "180nH" 1 "" 0>
  <L L10 1 500 140 8 -26 0 1 "15nH" 1 "" 0>
  <GND * 1 500 170 0 0 0 0>
  <L L11 1 610 60 -26 -44 0 0 "110nH" 1 "" 0>
  <L L12 1 640 140 8 -26 0 1 "56nH" 1 "" 0>
  ...
  <C C14 1 190 140 -8 46 0 1 "15pF" 1 "" 0 "neutral" 0>
  <C C20 1 610 140 -8 46 0 1 "15pF" 1 "" 0 "neutral" 0>
  <C C18 1 470 140 -8 46 0 1 "56pF" 1 "" 0 "neutral" 0>
  <C C15 1 270 60 -26 10 0 0 "8.2pF" 1 "" 0 "neutral" 0>
  <C C17 1 410 60 -26 10 0 0 "4.7pF" 1 "" 0 "neutral" 0>
  <C C19 1 550 60 -26 10 0 0 "8.2pF" 1 "" 0 "neutral" 0>
  <C C16 1 330 140 -8 46 0 1 "56pF" 1 "" 0 "neutral" 0>
</Components>
<Wires>
  <70 60 70 110 "" 0 0 0 "">
  <70 60 220 60 "" 0 0 0 "">
